 ...
 * - Collect Them All / Master Set / True Master → Master Ball (UI adds a star badge for True Master)
...
/** Master Ball for "Collect Them All" and Master Set binders (including True Master; UI overlays star). */
...
/** Pokémon TCG Base Set symbol – used for Specific Set Collection (menu icon and fallback when set has symbol). */
