...
import { MASTER_BALL_ICON, POKE_BALL_ICON, POKE_BALL_ICON_BW_SENTINEL } from '@/src/constants/collectionIcons';
import {
      ...
      >
        ...
        >
          <Pressable style={styles.modalCard} onPress={() => {}}>
            ...
            >
              <View style={[styles.menuOptionIcon, styles.menuOptionIconCenter]}>
                <FontAwesome name="th-large" size={28} color="rgba(255,255,255,0.9)" />
              </View>
